<%-- 
    Document   : ActivityReports
    Created on : 26 Feb, 2018, 10:56:55 AM
    Author     : Vidya
--%>

<%@page import="com.integra.utils.ValidateSession"%>
<%@page contentType="text/html" pageEncoding="UTF-8" language="java" errorPage="errorpage.jsp"%>
...
//                request.getSession().invalidate();
        ...
        <sql:query var="acivityReport"   dataSource="${myDS}">
            ...
            CASE WHEN is_downloaded='0' THEN "No" ELSE "Yes" END AS is_downloaded FROM activity_report WHERE user_id=<%=user.getUserId()%> order by transaction_date desc;
        </sql:query>
            ...
            <div class="row">
                ...
                <div id="" class="col-sm-12 col-md-12 col-lg-12">
                    ...
                    <table id="" class="table table-bordered styleSubDiv styleRptTable" style="border:1px solid #002166;background-color:#ccccff;font-size:14px">
                        ...
                        <tr class="row styleTableHdr" id="id_records_found">
