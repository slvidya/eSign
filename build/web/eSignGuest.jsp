            ...
            <div class="row">
                <div class="col-xs-offset-0 col-xs-12 col-sm-offset-0 col-sm-12 col-md-offset-0 col-md-12 col-lg-offset-0 col-lg-12" style="margin-top:-15px;text-align:center;">
                    <div class="row" style="">
                        ...
                        <div class="col-sm-3 col-md-3 col-lg-3" align="right" style="margin-top:40px;">
                            <p id="txtWelcomeSuffixName" style="color:#8d8d8d;float:right"><h5><b>Guest</b></h5></p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-offset-1 col-md-10 col-sm-offset-0 col-sm-12 col-xs-offset-0 col-xs-12" style="border:1px solid #002166;background-color:#ccccff">
                            ...
                            <table class="table">
                                <tr class="row">
                                    ...
                                    <td class="col-md-3 col-sm-3 col-xs-3" align="right">
                                        <input class="btn btn-primary" type="submit" id="btneSign" style="margin-top:0px;margin-bottom:20px" value="eSign"/>
                                    </td>
                                    <td class="col-md-3 col-sm-3 col-xs-3" align="left">
                                        <input class="btn btn-primary" type="button" id="btnCanceleSign" style="margin-top:0px;margin-bottom:20px" value="Cancel" onclick="location.href = 'Login.jsp'"/>
                                    </td>
                                    <td class="col-md-3 col-sm-3 col-xs-3">
                                    </td>
                                </tr>
